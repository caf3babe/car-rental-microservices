package at.ac.fhcampuswien.se.group1.core.domain.dto;
...
public class CarRequest {
    ...
    @Valid
    @Schema(name = "picture_link", required = true, example = "https://www.auto-data.net/en/audi-tt-rs-roadster-8s-facelift-2019-generation-7105#image8")
