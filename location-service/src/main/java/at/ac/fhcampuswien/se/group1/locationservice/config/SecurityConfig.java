...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.logout(logout -> logout
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/car").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/car/findByStatus").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/v1/liveness").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/currency").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/opening-hours").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/opening-hours/**").permitAll()
